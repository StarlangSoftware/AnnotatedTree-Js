...
import {ParseTreeDrawable} from "../dist/ParseTreeDrawable";

describe('ParseTreeDrawableTest', function() {
    describe('ParseTreeDrawableTest', function () {
        let tree0 = new ParseTreeDrawable("trees/0000.dev");
        let tree1 = new ParseTreeDrawable("trees/0001.dev");
        let tree2 = new ParseTreeDrawable("trees/0002.dev");
        let tree3 = new ParseTreeDrawable("trees/0003.dev");
        let tree4 = new ParseTreeDrawable("trees/0004.dev");
        let tree5 = new ParseTreeDrawable("trees/0005.dev");
        let tree6 = new ParseTreeDrawable("trees/0006.dev");
        let tree7 = new ParseTreeDrawable("trees/0007.dev");
        let tree8 = new ParseTreeDrawable("trees/0008.dev");
        let tree9 = new ParseTreeDrawable("trees/0009.dev");
        it('testMaxDepth', function () {
            assert.strictEqual(5, tree0.maxDepth());
            assert.strictEqual(5, tree1.maxDepth());
            assert.strictEqual(5, tree2.maxDepth());
            assert.strictEqual(5, tree3.maxDepth());
            assert.strictEqual(6, tree4.maxDepth());
            assert.strictEqual(3, tree5.maxDepth());
            assert.strictEqual(4, tree6.maxDepth());
            assert.strictEqual(6, tree7.maxDepth());
        ...
        it('testGenerateAnnotatedSentence', function () {
            ...
            assert.strictEqual("{turkish=Yollar}{morphologicalAnalysis=yol+NOUN+A3PL+PNON+NOM}{metaMorphemes=yol+lAr}{semantics=TUR10-0858630}{namedEntity=ORGANIZATION}{propbank=ARG0$TUR10-0834430} " +
            ...
            assert.strictEqual("{turkish=Biz}{morphologicalAnalysis=biz+PRON+PERS+A1PL+PNON+NOM}{metaMorphemes=biz}{semantics=TUR10-0110290}{namedEntity=NONE} " +
            ...
            assert.strictEqual("{turkish=Bu}{morphologicalAnalysis=bu+DET}{metaMorphemes=bu}{semantics=TUR10-0120750}{namedEntity=NONE}{propbank=ARGMTMP$TUR10-0328250} " +
            ...
            assert.strictEqual("{turkish=Shearson}{morphologicalAnalysis=shearson+NOUN+PROP+A3SG+PNON+NOM}{metaMorphemes=shearson}{semantics=TUR10-0000000}{namedEntity=ORGANIZATION}{propbank=ARG0$TUR10-0845200} " +
            ...
            assert.strictEqual("{turkish=Bu}{morphologicalAnalysis=bu+DET}{metaMorphemes=bu}{semantics=TUR10-0120750}{namedEntity=NONE} " +
            ...
            assert.strictEqual("{turkish=Bu}{morphologicalAnalysis=bu+DET}{metaMorphemes=bu}{semantics=TUR10-0120760}{namedEntity=NONE} " +
            ...
            assert.strictEqual("{turkish=Cuma}{morphologicalAnalysis=cuma+NOUN+A3SG+PNON+NOM}{metaMorphemes=cuma}{semantics=TUR10-0142770}{namedEntity=TIME}{propbank=ARGMTMP$TUR10-0405220} " +
            ...
            assert.strictEqual("{turkish=Bunu}{morphologicalAnalysis=bu+PRON+DEMONSP+A3SG+PNON+ACC}{metaMorphemes=bu+nH}{semantics=TUR10-0120760}{namedEntity=NONE} " +
            ...
            assert.strictEqual("{turkish=Bu}{morphologicalAnalysis=bu+PRON+DEMONSP+A3SG+PNON+NOM}{metaMorphemes=bu}{semantics=TUR10-0120760}{namedEntity=NONE}{propbank=ARG0$TUR10-0915630} " +
        ...
        it('testGenerateAnnotatedSentence2', function () {
            let tree = new ParseTreeDrawable("trees2/0000.dev");
            assert.strictEqual("{english=The}{posTag=DT} {english=complicated}{posTag=VBN} {english=language}{posTag=NN} {english=in}{posTag=IN} {english=the}{posTag=DT} {english=huge}{posTag=JJ} {english=new}{posTag=JJ} {english=law}{posTag=NN} {english=has}{posTag=VBZ} {english=muddied}{posTag=VBN} {english=the}{posTag=DT} {english=fight}{posTag=NN} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0001.dev");
            assert.strictEqual("{english=The}{posTag=DT} {english=Ways}{posTag=NNP} {english=and}{posTag=CC} {english=Means}{posTag=NNP} {english=Committee}{posTag=NNP} {english=will}{posTag=MD} {english=hold}{posTag=VB} {english=a}{posTag=DT} {english=hearing}{posTag=NN} {english=on}{posTag=IN} {english=the}{posTag=DT} {english=bill}{posTag=NN} {english=next}{posTag=IN} {english=Tuesday}{posTag=NNP} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0002.dev");
            assert.strictEqual("{english=We}{posTag=PRP} {english='re}{posTag=VBP} {english=about}{posTag=IN} {english=to}{posTag=TO} {english=see}{posTag=VB} {english=if}{posTag=IN} {english=advertising}{posTag=NN} {english=works}{posTag=VBZ} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0003.dev");
            assert.strictEqual("{english=This}{posTag=DT} {english=time}{posTag=NN} {english=around}{posTag=RP} {english=,}{posTag=,} {english=they}{posTag=PRP} {english='re}{posTag=VBP} {english=moving}{posTag=VBG} {english=even}{posTag=RB} {english=faster}{posTag=RBR} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0004.dev");
            assert.strictEqual("{english=Shearson}{posTag=NNP} {english=Lehman}{posTag=NNP} {english=Hutton}{posTag=NNP} {english=Inc.}{posTag=NNP} {english=by}{posTag=IN} {english=yesterday}{posTag=NN} {english=afternoon}{posTag=NN} {english=had}{posTag=VBD} {english=already}{posTag=RB} {english=written}{posTag=VBN} {english=new}{posTag=JJ} {english=TV}{posTag=NN} {english=ads}{posTag=NNS} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0005.dev");
            assert.strictEqual("{english=This}{posTag=DT} {english=time}{posTag=NN} {english=,}{posTag=,} {english=the}{posTag=DT} {english=firms}{posTag=NNS} {english=were}{posTag=VBD} {english=ready}{posTag=JJ} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0006.dev");
            assert.strictEqual("{english=``}{posTag=``} {english=To}{posTag=TO} {english=maintain}{posTag=VB} {english=that}{posTag=DT} {english=dialogue}{posTag=NN} {english=is}{posTag=VBZ} {english=absolutely}{posTag=RB} {english=crucial}{posTag=JJ} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0007.dev");
            assert.strictEqual("{english=It}{posTag=PRP} {english=would}{posTag=MD} {english=have}{posTag=VB} {english=been}{posTag=VBN} {english=too}{posTag=RB} {english=late}{posTag=JJ} {english=to}{posTag=TO} {english=think}{posTag=VB} {english=about}{posTag=IN} {english=on}{posTag=IN} {english=Friday}{posTag=NNP} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0008.dev");
            assert.strictEqual("{english=We}{posTag=PRP} {english=had}{posTag=VBD} {english=to}{posTag=TO} {english=think}{posTag=VB} {english=about}{posTag=IN} {english=it}{posTag=PRP} {english=ahead}{posTag=RB} {english=of}{posTag=IN} {english=time}{posTag=NN} {english=.}{posTag=.} {english=''}{posTag=''}",
                tree.generateAnnotatedSentence("english").toString());
            tree = new ParseTreeDrawable("trees2/0009.dev");
            assert.strictEqual("{english=It}{posTag=PRP} {english=goes}{posTag=VBZ} {english=on}{posTag=RB} {english=to}{posTag=TO} {english=plug}{posTag=VB} {english=a}{posTag=DT} {english=few}{posTag=JJ} {english=diversified}{posTag=JJ} {english=Fidelity}{posTag=NNP} {english=funds}{posTag=NNS} {english=by}{posTag=IN} {english=name}{posTag=NN} {english=.}{posTag=.}",
                tree.generateAnnotatedSentence("english").toString());
        });
    });
})
